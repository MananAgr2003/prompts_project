  ...
  return (
    <section className="w-full max-w-full flex-start flex-col">
      ...
      <p className="desc text-left max-w-md">
        ...
        run wild with the Ai powered platforms
      </p>
      ...
      >
        <label>
          ...
          <textarea
            value={post.prompt}
            onChange={(e) => setPost({ ...post, prompt: e.target.value } , console.log(e.target.value))}
        ...
        <label>
          <span className="font-satoshi font-semibold text-base text-gray-700">
            Tag <span className="font-normal">(#web #idea)</span>
          </span>
